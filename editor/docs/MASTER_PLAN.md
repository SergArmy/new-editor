...
4. Блоки (Группы 4–5)
   ...
   - [~] Специализированные блоки (Checklist, Steps, Diagram, PlantUML, Comparison, Definition, Roles, Action) — In Progress: 2025-11-07 21:00
     ...
     - [x] DiagramBlock и PlantUMLBlock (расширенный функционал) — Completed At: 2025-11-07 23:30
      ...
      - [x] Стабилизация выделения ссылок (масштаб без сдвига) — Completed At: 2025-11-08 20:10
      - [x] Редактор ссылок с выходом за границы блока — Completed At: 2025-11-08 20:25
      - [x] Hover-анимации и визуальные состояния ссылок диаграмм — Completed At: 2025-11-08 19:45
     - [x] Подсветка PlantUML в редакторе диаграмм — Completed At: 2025-11-08 (session 1)
   - [ ] TableBlock — расширенный функционал (Plan Approved: 2025-11-08 (session 3))
     - [ ] Этап 1: Новая модель данных и безопасный рендер (ячейки, миграция, экранирование)
     - [ ] Этап 2: Структурные команды (вставка/удаление строк и столбцов, выбор, undo/redo)
     - [ ] Этап 3: Редактирование и форматирование ячеек (inline-редактор, форматирование, панель действий)
     - [ ] Этап 4: Расширенные операции (объединение/разделение, сортировка, изменение ширины, экспорт CSV)
     - [ ] Этап 5: Интеграции и полировка (контекстное меню, Clipboard, стили, тесты, документация)
  - [x] ComparisonBlock — Completed At: 2025-11-08 18:30; Обновлено: 2025-11-08 20:45 (CodeBlock + иконки); Обновлено: 2025-11-08 22:45 (расширенный набор иконок); Обновлено: 2025-11-08 23:45 (IconPickerMenu + IconLibraryService); Обновлено: 2025-11-09 00:35 (стабилизация статусов и diff-контента для юнит-тестов)
      - [x] Контекстное меню иконок ComparisonBlock — Completed At: 2025-11-08 21:40
     - [x] DefinitionBlock — Completed At: 2025-11-08 22:30 (минимальное определение)
     - [x] ActionBlock — Completed At: 2025-11-08 22:55
    - [x] RolesBlock — Completed At: 2025-11-08 23:15; Updated: 2025-11-09 00:05 (цветовые бейджи, палитра, RolesRegistry); Обновлено: 2025-11-09 00:35 (Assert.notStrictEqual для стабильности тестов)
    - [x] Демонстрационный документ охватывает все типы блоков — Completed At: 2025-11-08 (session 4)

## Следующие шаги:
- Контекстное меню редактора (реализация согласно проекту)
- Использование RolesRegistry в сценариях проекта
- TableBlock — расширенный функционал (см. раздел «4. Блоки → TableBlock»)
- Система плагинов
...
7. Взаимодействия (Группа 8)
   ...
   - [~] Контекстное меню редактора — In Progress: 2025-11-09 00:40
     - Определены общие команды (копировать, вставить, удалить, отмена/повтор, перемещение, добавление)
     - Спроектированы ContextMenuManager и схема подменю «Добавить»/«Добавить дочерний»
     - Подготовлен интерфейс регистрации блок-специфичных действий через ContextCommandRegistry
...
9. UI‑интеграция и стили (Группа 11)
   ...
   - [x] Унификация иконок Font Awesome — Completed At: 2025-11-08 21:15
  - [x] Глобальный IconPickerMenu и библиотека иконок — Completed At: 2025-11-08 23:45; Обновлено: 2025-11-09 00:35 (IconLibraryService предотвращает дублирование пользовательских иконок)
...
8. [~] Контекстное меню редактора — In Progress: 2025-11-09 00:40
   - Проектирование завершено (ContextMenuManager, ContextCommandRegistry, правила отображения)
   - Следующий шаг: реализация и подключение к EditorCore
